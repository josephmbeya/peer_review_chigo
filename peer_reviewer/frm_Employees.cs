    ...
    public partial class frm_Employees : Form
    {
        ...
        private void btnempsave_Click(object sender, EventArgs e)
        {
            ...
            if (txtcode.Text == "" || txtfname.Text== "" || txtlname.Text == "" || txtmname.Text == "" 
                ...
                || txtage.Text == "" || txtemerg.Text == "" || txtdrate.Text == "")
            {
...

        {
            ...
            else
            {
                ...
                sql = "UPDATE `employee_workinfo` SET  `d_rate`='" + txtdrate.Text
                  + "', `p_method`='" + txtpmethod.Text + "', `position`='";
                 // + "', `w_status`='" "', `d_hired`='" + dtpdhired.Text + "' WHERE `emp_code`='" + txtcode.Text + "'";
                config.Execute_Query(sql);
        ...
        private void dtpdhired_ValueChanged(object sender, EventArgs e)
        {
